#!/bin/bash
#SBATCH --job-name=densenet121_weighted_bce     # Name of job
...
# Weighted BCE - reweights loss by class frequency
python main.py --train --model DenseNet121 --proj densenet121_weighted_bce --loss weighted_bce
