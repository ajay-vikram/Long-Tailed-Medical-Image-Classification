#!/bin/bash
#SBATCH --job-name=densenet121_equalization    # Name of job
...
# Equalization Loss - focuses on hard examples and balances class contributions
python main.py --train --model DenseNet121 --proj densenet121_equalization --loss equalization --eq_gamma 2.0 --eq_lam 0.1
