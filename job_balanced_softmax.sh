#!/bin/bash
#SBATCH --job-name=densenet121_balanced_softmax # Name of job
...
# Balanced Softmax Loss - adjusts logits by class frequency
python main.py --train --model DenseNet121 --proj densenet121_balanced_softmax --loss balanced_softmax
