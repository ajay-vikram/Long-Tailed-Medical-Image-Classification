#!/bin/bash
#SBATCH --job-name=densenet121_ldam            # Name of job
...
# LDAM Loss - maintains per-class margins inversely proportional to class frequency
python main.py --train --model DenseNet121 --proj densenet121_ldam --loss ldam --ldam_max_m 0.5 --ldam_s 30
